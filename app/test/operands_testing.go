...
// GetOperandsOK runs the method Get of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetOperandsOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.OperandsController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
	...
	getCtx, _err := app.NewGetOperandsContext(goaCtx, req, service)
	if _err != nil {
